...
Feature: Dashboard View Validation
  ...
  Scenario: Verify Timeline Controls
    ...
    Then the "chart volume" element should visually match the baseline image "dashboard_chart_volume" with a 8.0% tolerance
  ...
  Scenario: Verify Incident and Sector Lists
    ...
    Then the "lists panel" element should visually match the baseline image "dashboard_lists_panels" with a 5.0% tolerance
  ...
  Scenario: Verify Global Actions and Filters
    ...
    And I wait for 1 seconds
    Then the "actions log" element should visually match the baseline image "dashboard_actions_log" with a 10.0% tolerance
  ...
  Scenario: Verify Navigation to Incident Taxonomy
    ...
    Then the "incidents taxonomy" page should visually match the baseline image "incident_taxonomy_page" with a 5.0% tolerance
