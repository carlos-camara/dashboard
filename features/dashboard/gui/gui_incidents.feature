...
Feature: Incident Taxonomy & Analysis
  ...
  Scenario: Verify Incident Statistics
    ...
    Then the "incident stats" element should visually match the baseline image "incident_stats_cards" without elements and with a 5.0% tolerance
      | element             |
      | stats_total_value   |
      | stats_sectors_value |
      | stats_unique_value  |
  ...
  Scenario: Verify Project Filtering
    ...
    Then the "project dropdown" element should visually match the baseline image "incident_project_dropdown" without elements and with a 8.0% tolerance
      | element              |
      | filters_project_item |
  ...
  Scenario: Verify Incident Expansion and Details
    ...
    Then the "incident expanded" element should visually match the baseline image "incident_expanded_details" without elements and with a 5.0% tolerance
      | element                  |
