...
Feature: Ultra-Professional Performance Dashboard Validation
  ...
  Scenario: Validate High-Density Performance Audit Dossier
    ...
    Then the "performance dashboard" page should visually match the baseline image "final_performance_dashboard_verification" without elements and with a 10.0% tolerance
         | element               |
         | efficiency_score      |
         | velocity_score        |
         | integrity_score       |
