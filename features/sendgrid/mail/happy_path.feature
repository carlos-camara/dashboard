@api @sendgrid @mail_send @happy @smoke
Feature: SendGrid Mail Send - Happy Path

  Background:
    Given the API base URL is "https://sendgrid-v3-api.mock.beeceptor.com"

  Scenario: POST /v3/mail/send returns 202 Accepted with correct body
    When I set request headers
      | Header       | Value            |
      | Content-Type | application/json |
    And I send a "POST" request to "/v3/mail/send" with JSON body
      """
      {
        "personalizations": [
          {
